...
public class HListView extends AbsHListView {
	 ...
	 * {@link #setAdapter(ListAdapter)} but might be a {@link android.widget.WrapperListAdapter}.
	 * 
	 ...
	 * 
	 * The adapter passed to this method may be wrapped by a {@link android.widget.WrapperListAdapter}, depending on the ListView features currently
