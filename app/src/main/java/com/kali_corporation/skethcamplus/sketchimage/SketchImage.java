...
package com.kali_corporation.skethcamplus.sketchimage;
...
public class SketchImage {
    ...
    public static final int ORIGINAL_TO_ORIGINAL = 0;
    public static final int ORIGINAL_TO_GRAY = 1;
    public static final int ORIGINAL_TO_SKETCH = 2;
    public static final int ORIGINAL_TO_COLORED_SKETCH = 3;
    public static final int ORIGINAL_TO_SOFT_SKETCH = 4;
    public static final int ORIGINAL_TO_SOFT_COLOR_SKETCH = 5;
    public static final int GRAY_TO_SKETCH = 6;
    public static final int GRAY_TO_COLORED_SKETCH = 7;
    public static final int GRAY_TO_SOFT_SKETCH = 8;
    public static final int GRAY_TO_SOFT_COLOR_SKETCH = 9;
    public static final int SKETCH_TO_COLOR_SKETCH = 10;
    ...
    public Bitmap getImageAs(int type, int value) {
        ...
        switch (type){
            case ORIGINAL_TO_ORIGINAL:
                bmGray = toGrayscale(bitmap, 100); //101-i
                bmInvert = toInverted(bmGray, 0); //i
                bmBlur = toBlur(bmInvert, 0); //i
            ...
            case ORIGINAL_TO_SOFT_SKETCH:
                bmGray = toGrayscale(bitmap, 101-value); //101-i
                bmInvert = toInverted(bmGray, 90); //i
                bmBlur = toBlur(bmInvert, 1); //i
                bmBlend = colorDodgeBlend(bmBlur, bmGray, 100);
                return bmBlend;
            ...
            case ORIGINAL_TO_SOFT_COLOR_SKETCH:
                bmGray = toGrayscale(bitmap, 100); //101-i
                bmInvert = toInverted(bmGray, value); //i
                bmBlur = toBlur(bmInvert, 90); //i
                bmBlend = colorDodgeBlend(bmBlur, bmGray, 100);
                return bmBlend;

            case GRAY_TO_SKETCH:
                bmGray = toGrayscale(bitmap, 40); //101-i
                bmInvert = toInverted(bmGray, value); //i
                bmBlur = toBlur(bmInvert, 80); //i
                bmBlend = colorDodgeBlend(bmBlur, bmGray, 100);
                return bmBlend;
            ...
            case GRAY_TO_SOFT_SKETCH:
                bmGray = toGrayscale(bitmap, value-20); //101-i
                bmInvert = toInverted(bmGray, 96); //i
                bmBlur = toBlur(bmInvert, 20); //i
                bmBlend = colorDodgeBlend(bmBlur, bmGray, 98);
                return bmBlend;

            case GRAY_TO_SOFT_COLOR_SKETCH:
                bmGray = toGrayscale(bitmap, 166-value); //101-i
                bmInvert = toInverted(bmGray, value); //i
                bmBlur = toBlur(bmInvert, 100); //i
                bmBlend = colorDodgeBlend(bmBlur, bmGray, 100);
                return bmBlend;
